function initAdmin () {
	page.goEdit = function(pageId) {
		...
		$("#main[pageId='"+pageId+"']").after($("#wrapper #container [pageId=editPage]").show());
		$("#navi [pageId='"+pageId+"']").parent().after($("#wrapper #naviCase #editNavi").show());
	};

	page.hideEditPage = function () {
		$("#wrapper #naviCase #editNavi").hide();
		$("#wrapper #container [pageId=editPage]").hide();
	}
